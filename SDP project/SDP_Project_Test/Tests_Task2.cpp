...
TEST_CASE("Testing task 2 with default test case")
{
	...
	std::string expectedOutput = "Best Path: Railstation --> RomanStadium --> DzhumayaSquare --> ArtGallery --> AntiqueTheatre --> ArtGallery --> Railstation";
...
TEST_CASE("Testing task 2 where there are many useless paths which cycle back and forth between 2 already visited landmarks")
{
	...
	std::string actualOutput = executeTask2(testInputFileName, testInput);
	//Best Path: Railstation --> RomanStadium --> HistoricalMuseum --> AntiqueTheatre --> ArtGallery --> DzhumayaSquare --> RomanStadium --> Railstation
	//Best Path: Railstation --> RomanStadium --> DzhumayaSquare --> ArtGallery --> AntiqueTheatre --> HistoricalMuseum --> RomanStadium --> Railstation
	std::string expectedOutput = "Best Path: Railstation --> RomanStadium --> HistoricalMuseum --> AntiqueTheatre --> ArtGallery --> DzhumayaSquare --> RomanStadium --> Railstation";
...
TEST_CASE("Testing task 2 where there are many useless paths after already visiting all but 1 landmarks and all the visited landmarks have paths between eachother")
{
	...
	std::string expectedOutput =
		"Best Path: Railstation --> RomanStadium --> ArtGallery --> DzhumayaSquare --> HistoricalMuseumCopy --> AntiqueTheatre"
		+ std::string(" --> Railstation");
